...
public class CharacterManager : MonoBehaviour
{
    ...
    public BodyPart armLeft = new BodyPart("Arm Left", "arm", "", -6, new Vector2(0.19f, -0.07f), false, false, true, false, false);
    public BodyPart armRight = new BodyPart("Arm Right", "arm", "", -6, new Vector2(-0.18f, -0.07f), true, false, true, false, false);
    public BodyPart legLeft = new BodyPart("Leg Left", "leg", "", -6, new Vector2(0.03f, -0.42f), false, false, false, false, false);
    public BodyPart legRight = new BodyPart("Leg Right", "leg", "", -6, new Vector2(-0.11f, -0.42f), false, false, false, false, false);
