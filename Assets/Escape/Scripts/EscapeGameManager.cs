...
public class EscapeGameManager : MonoBehaviour
{
    ...
    [SerializeField] private EscapeLevel _level;
    [SerializeField] private SpriteRenderer _bgPrefab;
    [SerializeField] private EscapeGamePiece _piecePrefab;
    [SerializeField] private EscapeGamePiece _winPrefab;

    private bool hasGameFinished;
    private List<EscapeGamePiece> gamePieces;
    private EscapeGamePiece winPiece;
    private EscapeGamePiece currentPiece;
    ...
    private void SpawnLevel()
    {
        ...
        gamePieces = new List<EscapeGamePiece>();
        ...
        {
            EscapeGamePiece temp = Instantiate(_piecePrefab);
        ...
        //Set Up Camera
        Camera.main.orthographicSize = Mathf.Max(_level.Col, _level.Row) * 1.2f;
