...
public class EscapeGenerator : MonoBehaviour
{
    ...
    [SerializeField] private EscapeLevelPiece _piecePrefab;
    [SerializeField] private EscapeLevelPiece _winPrefab;

    private bool isStartPiece;

    private EscapeLevelPiece winPiece;
    private EscapeLevelPiece curPiece;
    ...
    private void SpawnLevel()
    {
        ...
        for (int i = 0; i < _level.Pieces.Count; i++)
        {
            ...
            EscapeLevelPiece temp = Instantiate(_piecePrefab);
